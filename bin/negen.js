...
var ARGS = yargs
    ...
    'package.json is used as config file, All [' + chalk.cyan('options') + '] are read from the object "' + chalk.blue('negen') + '" within package.json\n'
    + 'i.e.: ' + chalk.green('package.json') + ' => {"' + chalk.blue('negen') + '":{"' + chalk.cyan('blueprints_root') + '":"./tools/blueprints/","' + chalk.cyan('modules_root') + '":"./src/modules/"}}')
    .help()
    .wrap(null)
    .argv;
if (ARGS._.length == 0) {
